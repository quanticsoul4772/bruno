...
def test_baseline_refusals(model_path: str = None, num_prompts: int = 5):
    ...
    if not model_path.exists():
        ...
        print("  Skipping baseline test. Run with --model-path to specify model location.")
...
def main():
    ...
    parser.add_argument("--model-path", type=str, help="Path to model for baseline testing")
    ...
    print("  python -m heretic ./models/Qwen2.5-7B-Instruct -c experiments/code_refusal/config.code_refusal.toml -o experiments/code_refusal/")
